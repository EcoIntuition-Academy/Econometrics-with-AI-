...
const dir = path.join(__dirname, '..', 'modules', 'module-18');
...
console.log(`\n=== RESULT: ${totalChecked} math snippets checked in Module 18, ${totalErrors} errors found ===\n`);

if (totalErrors > 0) {
  process.exit(1);
} else {
  console.log('ALL MATHJAX SNIPPETS IN MODULE 18 COMPILED PERFECTLY WITH ZERO ERRORS! 🚀');
}
